export const speakerDataMock = [
  {
    speaker_id: '1',
    speaker_name: 'tonkhaow',
    eng_name: 'Ava',
    thai_name: 'เอวา',
    image:
    ...
    voice_style: ['เสียงน่ารัก'],
    eng_voice_style: ['Cute'],
    age_style: 'วัยรุ่น',
    eng_age_style: 'Teens',
    speech_style: ['สไตล์เล่าเรื่อง', 'สไตล์อ่านข่าว'],
    eng_speech_style: ['Storytelling', 'News Reading'],
    speed: 'พูดช้า',
    eng_speed: 'Slow',
    popularity: 'ยอดนิยม',
    eng_popularity: 'Popular',
    type: null,
    language: 'TH',
    status: true,
    gender: 'ผู้หญิง',
    ...
    private: false,
    allow_uid: [],
    available_language: ['en', 'id', 'ja', 'lo', 'my', 'th', 'vi', 'zh'],
    premier: false,
  },
  {
    speaker_id: '2',
    ...
    age_style: 'วัยเด็ก',
    eng_age_style: 'Child',
    speech_style: ['สไตล์เล่าเรื่อง', 'สไตล์ตัวละคร'],
    eng_speech_style: ['Storytelling', 'Character'],
    speed: 'พูดกลาง',
    eng_speed: 'Normal',
    popularity: 'ยอดนิยม',
    eng_popularity: 'Popular',
  ...
  },
  {
    ...
    voice_style: ['เสียงมั่นใจ'],
    eng_voice_style: ['Confident'],
    age_style: 'วัยผู้ใหญ่',
    eng_age_style: 'Adult',
    speech_style: ['สไตล์เล่าเรื่อง', 'สไตล์บรรยาย'],
    eng_speech_style: ['Storytelling', 'Narrating'],
    speed: 'พูดกลาง',
    eng_speed: 'Normal',
    popularity: 'ยอดนิยม',
    eng_popularity: 'Popular',
  ...
  },
  {
    ...
    voice_style: ['เสียงน่าเชื่อถือ'],
    eng_voice_style: ['Trustworthy'],
    age_style: 'วัยผู้ใหญ่',
    eng_age_style: 'Adult',
    speech_style: ['สไตล์เล่าเรื่อง', 'สไตล์อ่านข่าว'],
    eng_speech_style: ['Storytelling', 'News Reading'],
  ...
  },
  {
    ...
    voice_style: ['เสียงตื่นเต้น'],
    eng_voice_style: ['Exciting'],
    age_style: 'วัยผู้ใหญ่',
    eng_age_style: 'Adult',
    speech_style: ['สไตล์เล่าเรื่อง', 'สไตล์อ่านข่าว'],
    eng_speech_style: ['Storytelling', 'News Reading'],
  ...
  },
  {
    ...
    age_style: 'วัยผู้ใหญ่',
    eng_age_style: 'Adult',
    speech_style: ['สไตล์อ่านข่าว', 'สไตล์สปอตโฆษณา'],
    eng_speech_style: ['News Reading', 'Advertising Spot'],
    speed: 'พูดเร็ว',
    eng_speed: 'Fast',
    popularity: 'ยอดนิยม',
    eng_popularity: 'Popular',
  ...
  },
  {
    ...
    age_style: 'วัยรุ่น',
    eng_age_style: 'Teens',
    speech_style: ['สไตล์เล่าเรื่อง', 'สไตล์สารคดี'],
    eng_speech_style: ['Storytelling', 'Documentary'],
    speed: 'พูดกลาง',
    eng_speed: 'Normal',
    popularity: '-',
    eng_popularity: '-',
  ...
  },
  {
    ...
    age_style: 'วัยรุ่น',
    eng_age_style: 'Teens',
    speech_style: ['สไตล์บรรยาย', 'สไตล์ตัวละคร'],
    eng_speech_style: ['Narrating', 'Character'],
    speed: 'พูดกลาง',
    eng_speed: 'Normal',
    popularity: '-',
    eng_popularity: '-',
  ...
  },
  {
    ...
    voice_style: ['เสียงจริงจัง'],
    eng_voice_style: ['Serious'],
    age_style: 'วัยรุ่น',
    eng_age_style: 'Teens',
    speech_style: ['สไตล์เล่าเรื่อง', 'สไตล์บรรยาย'],
    eng_speech_style: ['Storytelling', 'Narrating'],
  ...
  },
  {
    ...
    voice_style: ['เสียงหวาน'],
    eng_voice_style: ['Sweet'],
    age_style: 'วัยรุ่น',
    eng_age_style: 'Teens',
    speech_style: ['สไตล์เล่าเรื่อง', 'สไตล์ตัวละคร'],
    eng_speech_style: ['Storytelling', 'Character'],
  ...
  },
  {
    ...
    age_style: 'วัยรุ่น',
    eng_age_style: 'Teens',
    speech_style: ['สไตล์ตัวละคร', 'สไตล์อนิเมะ'],
    eng_speech_style: ['Character', 'Anime'],
    speed: 'พูดกลาง',
    eng_speed: 'Normal',
    popularity: '-',
    eng_popularity: '-',
  ...
  },
  {
    ...
    age_style: 'วัยผู้ใหญ่',
    eng_age_style: 'Adult',
    speech_style: ['สไตล์บรรยาย', 'สไตล์อาจารย์'],
    eng_speech_style: ['Narrating', 'Teaching'],
    speed: 'พูดกลาง',
    eng_speed: 'Normal',
    popularity: '-',
    eng_popularity: '-',
  ...
  },
  {
    ...
    voice_style: ['เสียงขี้เล่น'],
    eng_voice_style: ['Playful'],
    age_style: 'วัยรุ่น',
    eng_age_style: 'Teens',
    speech_style: ['สไตล์ตัวละคร', 'สไตล์อนิเมะ'],
    eng_speech_style: ['Character', 'Anime'],
  ...
  },
  {
    ...
    voice_style: ['เสียงทุ้ม'],
    eng_voice_style: ['Deep'],
    age_style: 'วัยผู้ใหญ่',
    eng_age_style: 'Adult',
    speech_style: ['สไตล์เล่าเรื่อง', 'สไตล์ตัวละคร'],
    eng_speech_style: ['Storytelling', 'Character'],
  ...
  },
  {
    ...
    voice_style: ['เสียงนุ่มนวล'],
    eng_voice_style: ['Gentle'],
    age_style: 'วัยรุ่น',
    eng_age_style: 'Teens',
    speech_style: ['สไตล์เล่าเรื่อง', 'สไตล์บรรยาย'],
    eng_speech_style: ['Storytelling', 'Narrating'],
  ...
  },
  {
    ...
    voice_style: ['เสียงท้องถิ่น'],
    eng_voice_style: ['Regional accent'],
    age_style: 'วัยผู้ใหญ่',
    eng_age_style: 'Adult',
    speech_style: ['สไตล์เล่าเรื่อง', 'สไตล์ท้องถิ่น'],
    eng_speech_style: ['Storytelling', 'Local'],
    speed: 'พูดกลาง',
    eng_speed: 'Normal',
    popularity: '-',
    eng_popularity: '-',
  ...
  },
  {
    ...
    age_style: 'วัยรุ่น',
    eng_age_style: 'Teens',
    speech_style: ['สไตล์อ่านข่าว', 'สไตล์เสียงต่างประเทศ'],
    eng_speech_style: ['News Reading', 'Foreign Voice'],
    speed: 'พูดกลาง',
    eng_speed: 'Normal',
    popularity: '-',
    eng_popularity: '-',
  ...
  },
  {
    ...
    age_style: 'วัยรุ่น',
    eng_age_style: 'Teens',
    speech_style: ['สไตล์เล่าเรื่อง', 'สไตล์เสียงต่างประเทศ'],
    eng_speech_style: ['Storytelling', 'Foreign Voice'],
    speed: 'พูดกลาง',
    eng_speed: 'Normal',
    popularity: '-',
    eng_popularity: '-',
  ...
  {
    speaker_id: '59',
    speaker_name: 'zh_atchariyadaman95',
    eng_name: 'Juan',
    thai_name: 'เจวียน',
    image:
    ...
    private: false,
    allow_uid: [],
    available_language: ['zh'],
    premier: false,
  },
  {
    speaker_id: '60',
    speaker_name: 'zh_jidapaamarangkul',
    eng_name: 'Xin',
    thai_name: 'ซิน',
    image:
  ...
  },
  {
    ...
    voice_style: ['เสียงใจเย็น'],
    eng_voice_style: ['Calm'],
    age_style: 'วัยผู้ใหญ่',
    eng_age_style: 'Adult',
    speech_style: ['สไตล์เล่าเรื่อง', 'สไตล์บรรยาย'],
    eng_speech_style: ['Storytelling', 'Narrating'],
  ...
  {
    speaker_id: '64',
    speaker_name: 'ja_parichat.yotsalae',
    eng_name: 'Sae',
    thai_name: 'ซาเอะ',
    image:
    ...
    age_style: 'วัยผู้ใหญ่',
    eng_age_style: 'Adult',
    speech_style: ['สไตล์อ่านข่าว', 'สไตล์เล่าเรื่อง'],
    eng_speech_style: ['News Reading', 'Storytelling'],
    speed: 'พูดกลาง',
    eng_speed: 'Normal',
    popularity: '-',
    eng_popularity: '-',
  ...
  {
    speaker_id: '66',
    speaker_name: 'id_chandra.irawan1889',
    eng_name: 'Taufik',
    thai_name: 'เทาฟิก',
    image:
  ...
  {
    speaker_id: '67',
    speaker_name: 'id_prasetyo.pamungkas11',
    eng_name: 'Tedi',
    thai_name: 'เทดี้',
    image:
  ...
  {
    speaker_id: '69',
    speaker_name: 'vi_minhcuong211001',
    eng_name: 'Dang',
    thai_name: 'ดั่ง',
    image:
  ...
  {
    speaker_id: '70',
    speaker_name: 'vi_phungvantienc7dubi',
    eng_name: 'Hung',
    thai_name: 'ฮง',
    image:
  ...
  {
    speaker_id: '73',
    speaker_name: 'vi_tranthiminhthu040802',
    eng_name: 'Phuong',
    thai_name: 'เฟื่อง',
    image:
    ...
    age_style: 'วัยผู้ใหญ่',
    eng_age_style: 'Adult',
    speech_style: ['สไตล์สารคดี', 'สไตล์บรรยาย'],
    eng_speech_style: ['Documentary', 'Narrating'],
    speed: 'พูดกลาง',
    eng_speed: 'Normal',
    popularity: '-',
    eng_popularity: '-',
  ...
  },
  {
    ...
    private: false,
    allow_uid: [],
    available_language: ['lo'],
    premier: false,
  },
  {
    speaker_id: '78',
    speaker_name: 'lo_bbb560576',
    eng_name: 'Sorn',
    thai_name: 'ศร',
    image:
    ...
    private: false,
    allow_uid: [],
    available_language: ['en', 'id', 'ja', 'km', 'lo', 'my', 'th', 'vi', 'zh'],
    premier: false,
  },
  {
    speaker_id: '79',
    speaker_name: 'lo_menubandasack',
    eng_name: 'Waris',
    thai_name: 'วริศ',
    image:
  ...
  {
    speaker_id: '83',
    speaker_name: 'my_oislppymnj_far',
    eng_name: 'Gawa',
    thai_name: 'กาว่า',
    image:
  ...
  {
    speaker_id: '84',
    speaker_name: 'my_somchaijanthon10',
    eng_name: 'Cetan',
    thai_name: 'ซีตาน',
    image:
  ...
  },
  {
    ...
    voice_style: ['เสียงชัดเจน'],
    eng_voice_style: ['Clear'],
    age_style: 'วัยรุ่น',
    eng_age_style: 'Teens',
    speech_style: ['สไตล์เล่าเรื่อง', 'สไตล์ท้องถิ่น'],
    eng_speech_style: ['Storytelling', 'Local'],
  ...
  },
  {
    ...
    voice_style: ['เสียงเหนือ'],
    eng_voice_style: ['Northern accent'],
    age_style: 'วัยรุ่น',
    eng_age_style: 'Teens',
    speech_style: ['สไตล์เล่าเรื่อง', 'สไตล์ท้องถิ่น'],
    eng_speech_style: ['Storytelling', 'Local'],
  ...
  },
  {
    ...
    voice_style: ['เสียงอีสาน'],
    eng_voice_style: ['Northeastern accent'],
    age_style: 'วัยผู้ใหญ่',
    eng_age_style: 'Adult',
    speech_style: ['สไตล์เล่าเรื่อง', 'สไตล์ท้องถิ่น'],
    eng_speech_style: ['Storytelling', 'Local'],
  ...
  {
    speaker_id: '140',
    speaker_name: 'km_kimchhoeurn_khy',
    eng_name: 'Chai',
    thai_name: 'ชัย',
    image:
  ...
  {
    speaker_id: '145',
    speaker_name: 'km_thanika_thorng',
    eng_name: 'Ratha',
    thai_name: 'รฐา',
    image:
